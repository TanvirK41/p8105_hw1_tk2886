...
2.  The unique **species** in the penguins data set are **Adelie,
    Gentoo, Chinstrap**.

3.  The unique **island** in the penguins data set are **Torgersen,
    Biscoe, Dream**.

4.  The unique **years** in the penguins data set are **2007, 2008,
    2009**.

5.  The **sex** in the penguins data set are **male, female**.

6.  The mean of the **bill length** is *43.92*. The standard deviation
    of the bill length is *5.46*.

7.  The mean of the **bill depth** is *17.15*. The standard deviation of
    the bill depth is *1.97*.

8.  The mean of the **flipper length** is *201*. The standard deviation
    of the flipper length is *14.06*.

9.  The mean of the **body mass** is *4201.75*. The standard deviation
    of the body mass is *801.95*.

10. The number of **rows** in the penguins data set is **344**.

11. The number of **columns** in the penguins data set is **8**.
