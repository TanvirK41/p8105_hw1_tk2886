...
b) The unique **species** in the penguins data set are **`r unique(pull(penguins, species))`**.

c) The unique **island** in the penguins data set are **`r unique(pull(penguins, island))`**.

d) The unique **years** in the penguins data set are **`r unique(pull(penguins, year), na.rm = TRUE)`**.

e) The **sex** in the penguins data set are **`r unique(na.omit(pull(penguins, sex)))`**.
